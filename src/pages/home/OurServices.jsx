            ...
            <div className='flex flex-col md:flex-row items-center justify-between gap-12'>
                ...
                <div className='md:w-1/2'>
                    <div className='text-left md:w-4/5'>
                        ...
                        <button className="btn bg-green rounded-full px-8 py-3 text-white">Explore</button>
                    </div>
                </div>
                    ...
                    <div className='grid sm:grid-cols-2 grid-cols-1 gap-8 items-center'>
                        {
                            serviceLists.map((service) => (
                                <div
                                    key={service.id}
                                    className='shadow-md rounded-md py-5 px-4 text-center space-y-2 text-green cursor-pointer hover:border-indigo-600 transition-all duration-200 hover:border'>
